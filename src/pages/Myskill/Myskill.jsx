        ...
        <div className=" p-8">
          <div className="space-y-6 place-content-center pt-16">
            <div className="  flex justify-between ">
              ...
              <h2 className="text-yellow-300 absolute mx-6 mr-14 mt-48 ml-11">Lorem ipsum dolor sit amet consectetur adipisicing elit. Error pariatur dolore ullam, deleniti nemo optio dignissimos harum doloribus repellat fugit, recusandae hic dolorem?.</h2>
                <img
                  src={dani}
                  alt=""
              ...
              <h2 className="text-yellow-300 absolute mx-6 mr-11 mt-48 ml-11">Lorem ipsum dolor consectetur adipisicing elit. Error pariatur dolore ullam, deleniti nemo optio dignissimos harum doloribus repellat fugit, recusandae hic dolorem?.</h2>
                <img
                  src={dani}
                  alt=""
            ...
            <div className="border-t-4 p-16">
              <h6 className="text-white font-extrabold text-4xl ">Skill Misi</h6>
              <div className="pt-6">
              <h5 className="text-blue-500 font-bold absolute text-6xl py-28 px-80">Bisnismen</h5>
                <img src={dn} alt="" className="w-screen rounded-full h-80 " />
              </div>
              <div className="pt-16">
              <h5 className="text-blue-500 font-bold absolute text-6xl py-28 px-80">Tranding</h5>
